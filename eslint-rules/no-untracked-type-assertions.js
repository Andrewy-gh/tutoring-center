...
const existingTypeAssertionEntries = [
  ...
  'features/admin-dashboard/admin-dashboard-content.tsx::`/dashboard?view=${nextView}` as Route<string>',
  'features/admin-dashboard/admin-session-columns.tsx::getValue() as string',
  'features/admin-dashboard/admin-session-columns.tsx::getValue() as string',
  'features/admin-dashboard/admin-session-columns.tsx::getValue() as string',
  'features/admin-dashboard/admin-session-columns.tsx::getValue() as string',
  'features/admin-dashboard/sessions-today-table.tsx::(await response.json().catch(() => null)) as { error?: string } | null',
  'features/admin-dashboard/sessions-today-table.tsx::getValue() as string',
  'features/admin-dashboard/sessions-today-table.tsx::getValue() as string',
  'features/admin-dashboard/sessions-today-table.tsx::getValue() as string',
  'features/admin-dashboard/sessions-today-table.tsx::getValue() as string',
  'features/admin-dashboard/sessions-today-table.tsx::row.original.status as Status',
  'features/admin-dashboard/sessions-today-table.tsx::value as Status',
  ...
  'features/parent-dashboard/parent-progress-dashboard.tsx::[] as ConfidenceDataPoint[]',
  'features/parent-dashboard/parent-progress-dashboard.tsx::[] as GradeDataPoint[]',
  'features/parent-dashboard/parent-progress-dashboard.tsx::[] as HomeworkDataPoint[]',
  'features/parent-dashboard/parent-progress-dashboard.tsx::[] as PerformanceDataPoint[]',
  ...
  'features/admin-dashboard/admin-dashboard-views.ts::value as ViewKey',
  'features/admin-dashboard/admin-dashboard-views.ts::value as ViewKey',
  ...
  'tests/features/parent-dashboard/charts.test.tsx::globalThis as { React?: unknown }',
  'tests/features/parent-dashboard/charts.test.tsx::globalThis as { React?: unknown }',
  'tests/features/parent-dashboard/charts.test.tsx::globalThis as { React?: unknown }',
  'tests/features/parent-dashboard/charts.test.tsx::globalThis as { React?: unknown }',
  'tests/features/parent-dashboard/charts.test.tsx::globalThis as { React?: unknown }',
