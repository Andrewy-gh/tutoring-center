...
export function AddCredits({
  submitButtonText = 'Add Credits',
  onPurchaseCompleteAction,
  onBackAction,
  ...
  if (showSuccessCard && purchased) {
    return (
      <SuccessCard title={successTitle} buttonLabel={successButtonLabel} href={successHref}>
        ...
        <p className='text-xs text-muted-foreground'>
          Confirmation code:{' '}
          <span className='font-mono font-semibold tracking-widest text-foreground'>{purchased.confirmationCode}</span>
        </p>
      </SuccessCard>
    );
  }
